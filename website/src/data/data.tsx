const Data = {
    heroSection: {
        ...
        title6: <>Transformation always starts with the shift of <u className="bg-gradient-to-r from-green-400 to-slate-50 bg-clip-text text-transparent">mindset</u>.</>,
        ...
        title8: <>Concept powered with <u className="bg-gradient-to-r from-green-400 to-slate-50 bg-clip-text text-transparent">research</u> is a magic in the making.</>,
